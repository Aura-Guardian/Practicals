...

{
...

    {
        ...
        case 1:
            ...
            printf("\nEnter the exprression with assignment operator: ");
        ...
        case 2:
            ...
            printf("\nEnter the exprression with arithmetic operator : ");
        ...
        case 3:
            ...
            printf(" Enter the exprression with relational operator  \n");

            scanf("%s %s %s", &id1, &op, &id2);

            if (((strcmp(op, "<") == 0) || (strcmp(op, ">") == 0) || (strcmp(op, "<=") == 0) || (strcmp(op, ">=") == 0) || (strcmp(op, "==") == 0) || (strcmp(op, "!=") == 0)) == 0)

                printf(" exprression is error ");
